            ...
            !(function(e) {
                ...
                let _ = (() => {
                    class I {
                        ...
                        runTask(t, o, y) {
                            ...
                            if (t.state === A && (t.type === R || t.type === M)) return;
                            const P = t.state != X;
                ...
                class m {
                  ...
                  o ? " or '" + o + "'" : ""
                        ...
                        (this._state = p), p == A && (this._zoneDelegates = null);
                    }
                    toString() {
            ...
            const Ue =
                ...
                qe = function(e) {
                    ...
                    const i = this || e.target || $,
                        r = i[n];
                    let c;
                    if (Ae && i === pe && "error" === e.type) {
                        const u = e;
                        (c =
                            r &&
                            r.call(this, u.message, u.filename, u.lineno, u.colno, u.error)), !0 === c && e.preventDefault();
                    } else
                    ...
                    D = function(E) {
                        ...
                        if (L)
                            if (1 === L.length) S(L[0], d, E);
                                ...
                                const z = L.slice();
                                for (let A = 0; A < z.length && (!E || !0 !== E[xe]); A++)
                                    S(z[A], d, E);
                            }
                    },
                    Z = function(E) {
                ...
                function B(E, d) {
                    ...
                    const p = L ?
                        ...
                        l = function(s, a, h, w, C = !1, k = !1) {
                            return function() {
                                ...
                                be && (be.taskData = j);
                                const fe = jt.scheduleEventTask(De, H, be, h, w);
                                return (
                                    (j.target = null),
                                    be && (be.taskData = null),
                                    st && (oe.once = !0),
                    ...
                    return (
                        ...
                        (O.prependListener = l(
                            ...
                            ".prependListener:",
                            function(s) {
                                return J.call(j.target, j.eventName, s.invoke, j.options);
                            },
                            t,
                            q, !0
                        )),
                ...
                Zone.__load_patch("XHR", (e, n) => {
                    !(function g(T) {
                        ...
                        const A = ce(
                                ...
                                () =>
                                function(v, M) {
                                    return (v[r] = 0 == M[2]), (v[f] = M[1]), A.apply(v, M);
                                }
                            ),
                            ...
                            j = ce(
                                ...
                                () =>
                                function(v, M) {
                                    if (!0 === n.current[X] || v[r]) return j.apply(v, M); {
                                        const R = {
                                                target: v,
                                                url: v[f],
                                                isPeriodic: !1,
                        ...
                        (function dt(e, n) {
                            ...
                            for (let r = 0; r < n.length; r++) {
                                ...
                                if (u) {
                                    ...
                                    e[c] = ((_) => {
                                        const g = function() {
                                            return _.apply(this, je(arguments, i + "." + c));
                                        };
                                        return ae(g, _), g;
                                    })(u);
                                }
