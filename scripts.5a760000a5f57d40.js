var Mo = Object.defineProperty,
    ...
    h = (g, p) => {
        ...
        if (hs)
            for (var A of hs(p)) Vo.call(p, A) && us(g, A, p[A]);
        return g;
    },
    Ot = (g, p) => Ro(g, Po(p));
!(function(g, p) {
    ...
    const m = {
        ...
        l = {
            find: (s, t = document.documentElement) => [].concat(...Element.prototype.querySelectorAll.call(t, s)),
    ...
    const Ln = new Set([
        ...
        Rn = (s, t) => {
            ...
            if (t.includes(e))
                return (!Ln.has(e) || Boolean(In.test(s.nodeValue) || Mn.test(s.nodeValue)));
            ...
            if (
                ((e = this._initializeOnDelegatedTarget(t, e)),
                    ...
                    (e._activeTrigger["focusout" === t.type ? xt : ct] =
                        e._element.contains(t.relatedTarget)), !e._isWithActiveTrigger())
            ) {
                if (
                    (clearTimeout(e._timeout),
                        (e._hoverState = "out"), !e._config.delay || !e._config.delay.hide)
                )
                    return void e.hide();
                e._timeout = setTimeout(() => {
    ...
    class dt extends v {
        ...
        _activate(t, e, i) {
            const o = (!e || ("UL" !== e.nodeName && "OL" !== e.nodeName) ?
                    l.children(e, os) :
                    l.find(rs, e)
                )[0],
